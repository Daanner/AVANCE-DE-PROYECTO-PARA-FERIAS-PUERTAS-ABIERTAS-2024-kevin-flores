                        ...
                        <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    @foreach ($tratamientos as $tratamiento)
                                        <tr>
                                            <td>{{ ++$i }}</td>
                                            <td>{{ $tratamiento->paciente ? $tratamiento->paciente->nombre . ' ' . $tratamiento->paciente->apellido_paterno . ' ' . $tratamiento->paciente->apellido_materno : 'N/A' }}</td>
                                            <td>{{ $tratamiento->user ? $tratamiento->user->name : 'N/A' }}</td>
