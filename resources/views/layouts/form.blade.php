      ...
      <div class="container px-4">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-main">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link nav-link-icon kanit-ExtraLight" href="{{route('register')}}">
                <i class="ni ni-circle-08"></i>
                <span class="nav-link-inner--text">Registrate</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link nav-link-icon kanit-ExtraLight" href="{{route('login')}}">
        ...
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted">
              © 2018 <a href="{{url('/')}}" class="font-weight-bold ml-1"> {{config('app.name')}}</a>
            </div>
          </div>
          <div class="col-xl-6">
            <ul class="nav nav-footer justify-content-center justify-content-xl-end">
              ...
              <li class="nav-item">
                <a href="#" class="nav-link kanit-ExtraLight" target="_blank">¿quienes somos?</a>
              </li>
